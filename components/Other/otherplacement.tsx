        ...
        <View style={styles.modalContent}>
          ...
          <View style={styles.buttonContainer}>
            ...
            <Pressable
              ...
              onPress={handleOtherPlacement}
            >
              <LinearGradient colors={Gradients.brand} start={{ x: 0, y: 0 }} end={{ x: 1, y: 0 }} style={styles.actionButton}>
                <Text style={styles.actionButtonText}>Place Item</Text>
              </LinearGradient>
            </Pressable>
          </View>
        </View>
